...
let colors = ['darkturquoise','cyan', 'aquamarine', 'paleturquoise','lightcyan']; //untuk pieplot
let url = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQyrVdDKYbuNvC0UzuyI9DLAZb9osMGJNJ9I1q0xZROg0JzCA3lwMLuZrof2_4IVQTcYVfGLK0U-JtX/pub?output=csv';
let urlAPI = "https://api.openweathermap.org/data/2.5/weather?q=LAMPUNG&appid=a431734d150b60e7f29763748c18c600&units=metric"
let dataSheet;
let dataAPI;
let xData;
let yData;
